...
export default function CompareProductivityTools() {
  const [tools, setTools] = useState<Tool[]>([]);

  useEffect(() => {
    const prodTools = allTools.filter(t => t.category === 'Productivity').slice(0, 6);
    setTools(prodTools);
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            ⚡ Best AI Productivity Tools Comparison
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Compare top AI productivity and automation tools
          </p>
        </div>
