...
export default function CompareVideoTools() {
  const [tools, setTools] = useState<Tool[]>([]);

  useEffect(() => {
    const videoTools = allTools.filter(t => t.category === 'Video').slice(0, 6);
    setTools(videoTools);
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Compare top AI video editing and generation tools
          </p>
        </div>
