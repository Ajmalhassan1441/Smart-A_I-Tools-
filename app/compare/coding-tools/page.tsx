...
export default function CompareCodingTools() {
  const [tools, setTools] = useState<Tool[]>([]);

  useEffect(() => {
    const codingTools = allTools.filter(t => t.category === 'Coding').slice(0, 6);
    setTools(codingTools);
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Compare top AI coding assistants and development tools
          </p>
        </div>
