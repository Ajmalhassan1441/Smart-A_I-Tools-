...
export default function CompareImageTools() {
  const [tools, setTools] = useState<Tool[]>([]);

  useEffect(() => {
    const imageTools = allTools.filter(t => t.category === 'Image').slice(0, 6);
    setTools(imageTools);
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Compare top AI image generation tools for creating stunning visuals
          </p>
        </div>
